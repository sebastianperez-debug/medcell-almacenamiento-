...
def render_almacenamiento(
    ...
    # y los mismos filtros visibles que los KPIs, para que el número descargado
    # coincida con "Ubicaciones disponibles".
    ...
    st.caption(
        "ℹ️ El total del botón **solo vacías (CSV)** usa los mismos filtros "
        "de Almacenamiento, Recetario, Pasillo, Bodega y Localizador que los KPIs."
    )
